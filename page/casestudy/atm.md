...
![ATMUseCaseDiagram](../../imgs/RM2Doc/ATMUseCaseDiagram.jpg)
...
<table>
	...
	<tr>
		...
		<td>
		<p><a href="#OPcreateBankCard">createBankCard</a></p><p><a href="#OPqueryBankCard">queryBankCard</a></p><p><a href="#OPmodifyBankCard">modifyBankCard</a></p><p><a href="#OPdeleteBankCard">deleteBankCard</a></p>
		</td>
	</tr>
	<tr>
		<td>UC5</td>
		...
		<td>The bank clerk manages bank card information, including entering, inquiring, modifying and deleting of bank card information</td>
		<td>
		<p><a href="#OPcreateUser">createUser</a></p><p><a href="#OPqueryUser">queryUser</a></p><p><a href="#OPmodifyUser">modifyUser</a></p><p><a href="#OPdeleteUser">deleteUser</a></p>
		</td>
	</tr>
	<tr>
		<td>UC6</td>
		<td><a href="#UCcardIdentification">cardIdentification</a></td>
...
<table>
	...
	<tr>
		...
		<td>The customer is the holder of the bank card</td>
		<td></td>
	</tr><tr>
		<td>A2</td>
		<td><span name ="ACTORBankClerk">BankClerk</span></td>
		<td>The bank clerk is responsible for managing information, including user(customer) information, bank card information</td>
		<td></td>
	</tr>
</table>
...
![ATMWithdrawCashSSD](../../imgs/RM2Doc/ATMWithdrawCashSSD.jpg)
...
![ATMCheckBalanceSSD](../../imgs/RM2Doc/ATMCheckBalanceSSD.jpg)
...
![ATMDepositFundsSSD](../../imgs/RM2Doc/ATMDepositFundsSSD.jpg)
...
Contract AutomatedTellerMachineSystem::inputCard(cardid :Integer) : Boolean {
		 ...
		 * If (the object bc existed), take the following as postcondition(s):
...
<p>Contract of <b>inputPassword</b>:</p>
...
<p>Contract of <b>printReceipt</b>:</p>
...
<p>Contract of <b>checkBalance</b>:</p>
...
<td><b>Preconditions:</b></td>
	...
	<tr>
		<td><b>Postconditions:</b></td>
	<td><p>1. The attribute <i>Balance</i> of the object <a href="#AutomatedTellerMachineSystemInputCard">InputCard</a> became its previous value minus <i>quantity</i></p><p>2. The value of temporary variable <a href="#AutomatedTellerMachineSystemWithdrawedNumber">WithdrawedNumber</a> became <i>quantity</i></p><p>3. The value of temporary variable <a href="#AutomatedTellerMachineSystemIsWithdraw">IsWithdraw</a> became <b>true</b></p><p>4. The return value was <b>true</b></p></td>
	</tr>
</table>

<p>Contract of <b>withdrawCash</b>:</p>
...
Contract AutomatedTellerMachineSystem::withdrawCash(quantity : Integer) : Boolean {
		...
		/*
		 * Generated by RM2Doc - Postcondition
		 * The attribute Balance of the object InputCard became its previous value minus quantity
...
Contract AutomatedTellerMachineSystem::depositFunds(quantity : Real) : Boolean {
		...
		/*
		 * Generated by RM2Doc - Postcondition
		 * The attribute Balance of the object InputCard became its previous value plus quantity
...
<td><p><i>bankcard</i> is the object <i>ban</i> in the instance set of class <a href="#CLASSBankCard">BankCard</a>. <i>ban</i> represents an object of class <a href="#CLASSBankCard">BankCard</a>, and <i>ban</i> meets:</p><p>&emsp;&emsp;The attribute <i>CardID</i> of the object <i>ban</i> is equal to <i>cardid</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>The object <i>bankcard</i> doesn't exist</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>createBankCard</b>:</p>
...
Contract  ManageBankCardCRUDService::createBankCard(cardid : Integer, cardstatus : CardStatus[NORMAL|SUSPEND|CANNEL], catalog : CardCatalog[CREDIT|DESPOSIT], password : Integer, balance : Real) : Boolean {
		...
		/*
		 * Generated by RM2Doc - Precondition
		 * The object bankcard doesn't exist
		 */
		precondition:
...
<tr>
			<td><b>Definition:</b></td>
<td><p><i>ban</i> is the object <i>ban</i> in the instance set of class <a href="#CLASSBankCard">BankCard</a>. <i>ban</i> represents an object of class <a href="#CLASSBankCard">BankCard</a>, and <i>ban</i> meets:</p><p>&emsp;&emsp;The attribute <i>CardID</i> of the object <i>bankcard</i> is equal to <i>cardid</i></p></td>
	</tr>
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>The object <i>ban</i> exists</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
	<td><p>The return value was <i>ban</i></p></td>
	</tr>
</table>

<p>Contract of <b>queryBankCard</b>:</p>

```java
Contract  ManageBankCardCRUDService::queryBankCard(cardid : Integer) : BankCard {
		/*
		 * Generated by RM2Doc - Definition
		 * ban is the object ban in the instance set of class BankCard. ban represents an object of class BankCard, and ban meets:
		 *     The attribute CardID of the object bankcard is equal to cardid
		 */
		definition:
			ban:BankCard = BankCard.allInstance()->any(ban:BankCard | bankcard.CardID = cardid)
		/*
		 * Generated by RM2Doc - Precondition
		 * The object ban exists
		 */
		precondition:
			ban.oclIsUndefined() = false
		/*
		 * Generated by RM2Doc - Postcondition
		 * The return value was ban
		 */
		postcondition:
			result = ban
}
...
<td><p><i>bankcard</i> is the object <i>ban</i> in the instance set of class <a href="#CLASSBankCard">BankCard</a>. <i>ban</i> represents an object of class <a href="#CLASSBankCard">BankCard</a>, and <i>ban</i> meets:</p><p>&emsp;&emsp;The attribute <i>CardID</i> of the object <i>ban</i> is equal to <i>cardid</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>The object <i>bankcard</i> exists</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>modifyBankCard</b>:</p>
...
<td><p><i>bankcard</i> is the object <i>ban</i> in the instance set of class <a href="#CLASSBankCard">BankCard</a>. <i>ban</i> represents an object of class <a href="#CLASSBankCard">BankCard</a>, and <i>ban</i> meets:</p><p>&emsp;&emsp;The attribute <i>CardID</i> of the object <i>ban</i> is equal to <i>cardid</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>1. The object <i>bankcard</i> exists</p><p>2. The object <i>bankcard</i> is in the instance set of class <a href="#CLASSBankCard">BankCard</a></p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>deleteBankCard</b>:</p>
...
<td><p><i>user</i> is the object <i>use</i> in the instance set of class <a href="#CLASSUser">User</a>. <i>use</i> represents an object of class <a href="#CLASSUser">User</a>, and <i>use</i> meets:</p><p>&emsp;&emsp;The attribute <i>UserID</i> of the object <i>use</i> is equal to <i>userid</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>The object <i>user</i> doesn't exist</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<td><p><i>user</i> is the object <i>use</i> in the instance set of class <a href="#CLASSUser">User</a>. <i>use</i> represents an object of class <a href="#CLASSUser">User</a>, and <i>use</i> meets:</p><p>&emsp;&emsp;The attribute <i>UserID</i> of the object <i>use</i> is equal to <i>userid</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>1. The object <i>user</i> exists</p><p>2. The object <i>user</i> is in the instance set of class <a href="#CLASSUser">User</a></p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>cardIdentification</b>:</p>
...
![ATMConceptualClassDiagram](../../imgs/RM2Doc/ATMConceptualClassDiagram.jpg)
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSBankCard">BankCard</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E1</td>
	...
	<tr>
	    ...
	    <td colspan="2">The BankCrad is a card that can deposit or withdraw money</td>
	</tr>
	<tr>
	...
	<tr>
	    <td>CardID</td>
	<td>Integer</td>
	<td>The CardID of BankCard</td>
					</tr>
	<tr>
	    <td>CardStatus</td>
	<td>[NORMAL|SUSPEND|CANNEL]</td>
	<td>The CardStatus of BankCard</td>
					</tr>
	<tr>
	    <td>Catalog</td>
	<td>[CREDIT|DESPOSIT]</td>
	<td>The Catalog of BankCard</td>
					</tr>
	<tr>
	    <td>Password</td>
	<td>Integer</td>
	<td>The Password of BankCard</td>
					</tr>
	<tr>
	    <td>Balance</td>
	<td>Real</td>
	<td>The Balance of BankCard</td>
					</tr>
	<tr>
...
<table>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The user is the holder of the bank card</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
