...
### LoanPS Requirements Model - Fully Download
...
![loanpsUseCaseDiagram](../../imgs/RM2Doc/loanpsUseCaseDiagram.jpg)
...
<table>
	...
	<tr>
		...
		<td>
		<p><a href="#OPlistTenLoanRequest">listTenLoanRequest</a></p><p><a href="#OPchooseOneForReview">chooseOneForReview</a></p><p><a href="#OPcheckCreditHistory">checkCreditHistory</a></p><p><a href="#OPreviewCheckingAccount">reviewCheckingAccount</a></p><p><a href="#OPlistAvaiableLoanTerm">listAvaiableLoanTerm</a></p><p><a href="#OPaddLoanTerm">addLoanTerm</a></p><p><a href="#OPapproveLoanRequest">approveLoanRequest</a></p>
		</td>
	</tr>
	<tr>
		<td>UC2</td>
		...
		<td></td>
		<td>
		<p><a href="#OPcreateLoanTerm">createLoanTerm</a></p><p><a href="#OPqueryLoanTerm">queryLoanTerm</a></p><p><a href="#OPmodifyLoanTerm">modifyLoanTerm</a></p><p><a href="#OPdeleteLoanTerm">deleteLoanTerm</a></p>
		</td>
	</tr>
	<tr>
		<td>UC3</td>
		...
		<td></td>
		<td>
		<p><a href="#OPlistSubmitedLoanRequest">listSubmitedLoanRequest</a></p><p><a href="#OPchooseLoanRequest">chooseLoanRequest</a></p><p><a href="#OPmarkRequestValid">markRequestValid</a></p>
		</td>
	</tr>
	<tr>
		<td>UC4</td>
		...
		<td>
		<p><a href="#OPlistApprovalRequest">listApprovalRequest</a></p><p><a href="#OPgenereateApprovalLetter">genereateApprovalLetter</a></p><p><a href="#OPemailToAppliant">emailToAppliant</a></p><p><a href="#OPgenerateLoanAgreement">generateLoanAgreement</a></p><p><a href="#OPprintLoanAgreement">printLoanAgreement</a></p>
		</td>
	</tr>
	<tr>
		<td>UC5</td>
	...
	<tr>
		...
		<td></td>
		<td><p><a href="#OPenterLoanInformation">enterLoanInformation</a></p><p><a href="#OPcreditRequest">creditRequest</a></p><p><a href="#OPaccountStatusRequest">accountStatusRequest</a></p><p><a href="#OPcalculateScore">calculateScore</a></p>
		</td>
	</tr>
</table>
...
<table>
	...
	<tr>
		<td>A1</td>
		<td><span name ="ACTORLoanOfficer">LoanOfficer</span></td>
		<td>a loan officer is an officer of the bank who has the designated responsibilitiy of evaluating requests for a loan</td>
		<td></td>
	</tr><tr>
		<td>A2</td>
		<td><span name ="ACTORLoanAssistant">LoanAssistant</span></td>
		<td>The loan assistant is responsible for manually capturing and entering into the system the credit information</td>
		<td></td>
	</tr><tr>
		<td>A3</td>
		<td><span name ="ACTORLoanClerk">LoanClerk</span></td>
		<td>The loan clerk is responsible for booking (recording and setting up) the loan</td>
		<td></td>
	</tr><tr>
		<td>A4</td>
		...
		<td>A5</td>
		<td><span name ="ACTORApplicant">Applicant</span></td>
		<td>An applicant is an individual or organization who sumits an application for a loan to the bank</td>
		<td></td>
	</tr>
</table>
...
![loanpsEvaluateLoanRequestSSD](../../imgs/RM2Doc/loanpsEvaluateLoanRequestSSD.jpg)
...
![loanpsGenerateLoanLetterAndAgreementSSD](../../imgs/RM2Doc/loanpsGenerateLoanLetterAndAgreementSSD.jpg)
...
<p>Contract of <b>enterLoanInformation</b>:</p>
...
<p>Contract of <b>creditRequest</b>:</p>
...
<p>Contract of <b>accountStatusRequest</b>:</p>
...
<p>Contract of <b>calculateScore</b>:</p>
...
<p>Contract of <b>listSubmitedLoanRequest</b>:</p>
...
<p>Contract of <b>chooseLoanRequest</b>:</p>
...
<p>Contract of <b>markRequestValid</b>:</p>
...
<p>Contract of <b>listTenLoanRequest</b>:</p>
...
<p>Contract of <b>chooseOneForReview</b>:</p>
...
<p>Contract of <b>checkCreditHistory</b>:</p>
...
<p>Contract of <b>reviewCheckingAccount</b>:</p>
...
<p>Contract of <b>listAvaiableLoanTerm</b>:</p>
...
<p>Contract of <b>addLoanTerm</b>:</p>
...
<p>Contract of <b>approveLoanRequest</b>:</p>
...
<p>Contract of <b>listApprovalRequest</b>:</p>
...
<p>Contract of <b>genereateApprovalLetter</b>:</p>
...
<p>Contract of <b>emailToAppliant</b>:</p>
...
<p>Contract of <b>generateLoanAgreement</b>:</p>
...
<p>Contract of <b>printLoanAgreement</b>:</p>
...
<p>Contract of <b>bookNewLoan</b>:</p>
...
<p>Contract of <b>generateStandardPaymentNotice</b>:</p>
...
<p>Contract of <b>generateLateNotice</b>:</p>
...
<p>Contract of <b>loanPayment</b>:</p>
...
<p>Contract of <b>closeOutLoan</b>:</p>
...
<p>Contract of <b>createLoanTerm</b>:</p>
...
<p>Contract of <b>queryLoanTerm</b>:</p>
...
<p>Contract of <b>modifyLoanTerm</b>:</p>
...
<p>Contract of <b>deleteLoanTerm</b>:</p>
...
<p>Contract of <b>getCheckingAccountStatus</b>:</p>
...
<p>Contract of <b>getCreditHistory</b>:</p>
...
<p>Contract of <b>createLoanAccount</b>:</p>
...
<p>Contract of <b>transferFunds</b>:</p>
...
<p>Contract of <b>listBookedLoans</b>:</p>
...
![loanpsConceptualClassDiagram](../../imgs/RM2Doc/loanpsConceptualClassDiagram.jpg)
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSLoanRequest">LoanRequest</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E1</td>
	...
	<td>The Status of LoanRequest</td>
					</tr>
	<tr>
	    <td>RequestID</td>
	<td>Integer</td>
	<td>The RequestID of LoanRequest</td>
					</tr>
	<tr>
	    <td>Name</td>
	<td>String</td>
	<td>The Name of LoanRequest</td>
					</tr>
	<tr>
	    <td>LoanAmount</td>
	<td>Real</td>
	<td>The LoanAmount of LoanRequest</td>
					</tr>
	<tr>
	    <td>LoanPurpose</td>
	<td>String</td>
	<td>The LoanPurpose of LoanRequest</td>
					</tr>
	<tr>
	    <td>Income</td>
	<td>Real</td>
	<td>The Income of LoanRequest</td>
					</tr>
	<tr>
	    <td>PhoneNumber</td>
	<td>Integer</td>
	<td>The PhoneNumber of LoanRequest</td>
					</tr>
	<tr>
	    <td>PostalAddress</td>
	<td>String</td>
	<td>The PostalAddress of LoanRequest</td>
					</tr>
	<tr>
	    <td>ZipCode</td>
	<td>Integer</td>
	<td>The ZipCode of LoanRequest</td>
					</tr>
	<tr>
	    <td>Email</td>
	<td>String</td>
	<td>The Email of LoanRequest</td>
					</tr>
	<tr>
	    <td>WorkReferences</td>
	<td>String</td>
	<td>The WorkReferences of LoanRequest</td>
					</tr>
	<tr>
	    <td>CreditReferences</td>
	<td>String</td>
	<td>The CreditReferences of LoanRequest</td>
					</tr>
	<tr>
	    <td>CheckingAccountNumber</td>
	<td>Integer</td>
	<td>The CheckingAccountNumber of LoanRequest</td>
					</tr>
	<tr>
	    <td>SecurityNumber</td>
	<td>Integer</td>
	<td>The SecurityNumber of LoanRequest</td>
					</tr>
	<tr>
	    <td>CreditScore</td>
	<td>Integer</td>
	<td>The CreditScore of LoanRequest</td>
					</tr>
	<tr>
...
<table>
	...
	<tr>
	    <td>LoanID</td>
	<td>Integer</td>
	<td>The LoanID of Loan</td>
					</tr>
	<tr>
	    <td>RemainAmountToPay</td>
	<td>Real</td>
	<td>The RemainAmountToPay of Loan</td>
					</tr>
	<tr>
	    <td>Status</td>
	<td>[LSOPEN|CLOSED]</td>
	<td>The Status of Loan</td>
					</tr>
	<tr>
	    <td>IsPaidinFull</td>
	<td>Boolean</td>
	<td>The IsPaidinFull of Loan</td>
					</tr>
	<tr>
	    <td>StartDate</td>
	<td>LocalDate</td>
	<td>The StartDate of Loan</td>
					</tr>
	<tr>
	    <td>EndDate</td>
	<td>LocalDate</td>
	<td>The EndDate of Loan</td>
					</tr>
	<tr>
	    <td>CurrentOverDueDate</td>
	<td>LocalDate</td>
	<td>The CurrentOverDueDate of Loan</td>
					</tr>
	<tr>
	    <td>RePaymentDays</td>
	<td>Integer</td>
	<td>The RePaymentDays of Loan</td>
					</tr>
	<tr>
	    <td>RepaymentAmount</td>
	<td>Real</td>
	<td>The RepaymentAmount of Loan</td>
					</tr>
	<tr>
	    <td><b>Relationship Name</b></td>
	<td><b>Related Entity</b></td>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSLoanTerm">LoanTerm</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E3</td>
	...
	<tr>
	    <td>ItemID</td>
	<td>Integer</td>
	<td>The ItemID of LoanTerm</td>
					</tr>
	<tr>
	    <td>Content</td>
	<td>String</td>
	<td>The Content of LoanTerm</td>
					</tr>
	</table>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSCheckingAccount">CheckingAccount</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E4</td>
	...
	<tr>
	    <td>Balance</td>
	<td>Real</td>
	<td>The Balance of CheckingAccount</td>
					</tr>
	<tr>
	    <td>Status</td>
	<td>[GOODSTANDING|SUSPENDED]</td>
	<td>The Status of CheckingAccount</td>
					</tr>
	</table>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSCreditHistory">CreditHistory</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E5</td>
	...
	<td>Real</td>
	<td>The OutstandingDebt of CreditHistory</td>
					</tr>
	<tr>
	    <td>BadDebits</td>
	<td>Integer</td>
	<td>The BadDebits of CreditHistory</td>
					</tr>
	</table>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSLoanAccount">LoanAccount</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E6</td>
	...
	<tr>
	    <td>LoanAccountID</td>
	<td>Integer</td>
	<td>The LoanAccountID of LoanAccount</td>
					</tr>
	<tr>
	    <td>Balance</td>
	<td>Real</td>
	<td>The Balance of LoanAccount</td>
					</tr>
	<tr>
	    <td>Status</td>
	<td>[NORMAL|HASPAIDINFULL]</td>
	<td>The Status of LoanAccount</td>
					</tr>
	</table>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSApprovalLetter">ApprovalLetter</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E7</td>
	...
	<tr>
	    <td>Content</td>
	<td>String</td>
	<td>The Content of ApprovalLetter</td>
					</tr>
	</table>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSLoanAgreement">LoanAgreement</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E8</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The loan agreement</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>Content</td>
	<td>String</td>
	<td>The Content of LoanAgreement</td>
					</tr>
	</table>
​	 
