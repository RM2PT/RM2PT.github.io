...
![libmsUseCaseDiagram](../../imgs/RM2Doc/libmsUseCaseDiagram.jpg)
...
<table>
	...
	<tr>
		...
		<td>
		<p><a href="#OPsearchBookByBarCode">searchBookByBarCode</a></p><p><a href="#OPsearchBookByTitle">searchBookByTitle</a></p><p><a href="#OPsearchBookByAuthor">searchBookByAuthor</a></p><p><a href="#OPsearchBookByISBN">searchBookByISBN</a></p><p><a href="#OPsearchBookBySubject">searchBookBySubject</a></p>
		</td>
	</tr>
	<tr>
		<td>UC2</td>
		...
		<td>
		<p><a href="#OPlistBorrowHistory">listBorrowHistory</a></p><p><a href="#OPlistHodingBook">listHodingBook</a></p><p><a href="#OPlistOverDueBook">listOverDueBook</a></p><p><a href="#OPlistReservationBook">listReservationBook</a></p><p><a href="#OPlistRecommendBook">listRecommendBook</a></p>
		</td>
	</tr>
	<tr>
		<td>UC3</td>
	...
	<tr>
		...
		<td>
		<p><a href="#OPcreateUser">createUser</a></p><p><a href="#OPqueryUser">queryUser</a></p><p><a href="#OPmodifyUser">modifyUser</a></p><p><a href="#OPdeleteUser">deleteUser</a></p><p><a href="#OPcreateStudent">createStudent</a></p><p><a href="#OPcreateFaculty">createFaculty</a></p><p><a href="#OPmodifyStudent">modifyStudent</a></p><p><a href="#OPmodifyFaculty">modifyFaculty</a></p>
		</td>
	</tr>
	<tr>
		<td>UC7</td>
		...
		<td>
		<p><a href="#OPcreateBook">createBook</a></p><p><a href="#OPqueryBook">queryBook</a></p><p><a href="#OPmodifyBook">modifyBook</a></p><p><a href="#OPdeleteBook">deleteBook</a></p>
		<p><a href="#OPaddBookCopy">addBookCopy</a></p><p><a href="#OPqueryBookCopy">queryBookCopy</a></p><p><a href="#OPmodifyBookCopy">modifyBookCopy</a></p><p><a href="#OPdeleteBookCopy">deleteBookCopy</a></p>
		</td>
	</tr>
	<tr>
		<td>UC8</td>
		...
		<td>
		<p><a href="#OPcreateSubject">createSubject</a></p><p><a href="#OPquerySubject">querySubject</a></p><p><a href="#OPmodifySubject">modifySubject</a></p><p><a href="#OPdeleteSubject">deleteSubject</a></p>
		</td>
	</tr>
	<tr>
		<td>UC9</td>
	...
	<tr>
		...
		<td>
		<p><a href="#OPcreateLibrarian">createLibrarian</a></p><p><a href="#OPqueryLibrarian">queryLibrarian</a></p><p><a href="#OPmodifyLibrarian">modifyLibrarian</a></p><p><a href="#OPdeleteLibrarian">deleteLibrarian</a></p>
		</td>
	</tr>
	<tr>
		<td>UC11</td>
...
<table>
	...
	<tr>
		...
		<td>A2</td>
		<td><span name ="ACTORFaculty">Faculty</span></td>
		<td>The faculty user</td>
		<td><a href="#ACTORUser">User</a></td>
	</tr><tr>
		<td>A3</td>
		<td><span name ="ACTORStudent">Student</span></td>
		<td>The student user</td>
		<td><a href="#ACTORUser">User</a></td>
	</tr><tr>
		<td>A4</td>
		...
		<td>A5</td>
		<td><span name ="ACTORLibrarian">Librarian</span></td>
		<td></td>
		<td></td>
	</tr><tr>
		<td>A6</td>
		...
		<td>A7</td>
		<td><span name ="ACTORThirdPartSystem">ThirdPartSystem</span></td>
		<td>The third part system</td>
		<td></td>
	</tr>
</table>
...
<p>Contract of <b>searchBookByBarCode</b>:</p>
...
<p>Contract of <b>searchBookByTitle</b>:</p>
...
<p>Contract of <b>searchBookByAuthor</b>:</p>
...
<p>Contract of <b>searchBookByISBN</b>:</p>
...
<p>Contract of <b>searchBookBySubject</b>:</p>
...
<p>Contract of <b>makeReservation</b>:</p>
...
<p>Contract of <b>cancelReservation</b>:</p>
...
<p>Contract of <b>borrowBook</b>:</p>
...
<p>Contract of <b>returnBook</b>:</p>
...
<p>Contract of <b>dueSoonNotification</b>:</p>
...
<p>Contract of <b>listBorrowHistory</b>:</p>
...
<p>Contract of <b>listHodingBook</b>:</p>
...
<p>Contract of <b>listOverDueBook</b>:</p>
...
<p>Contract of <b>listReservationBook</b>:</p>
...
<p>Contract of <b>listRecommendBook</b>:</p>
...
<p>Contract of <b>recommendBook</b>:</p>
...
<p>Contract of <b>createStudent</b>:</p>
...
<p>Contract of <b>modifyStudent</b>:</p>
...
<p>Contract of <b>createFaculty</b>:</p>
...
<p>Contract of <b>modifyFaculty</b>:</p>
...
<p>Contract of <b>sendNotificationEmail</b>:</p>
...
<p>Contract of <b>modifyUser</b>:</p>
...
<p>Contract of <b>deleteUser</b>:</p>
...
<p>Contract of <b>createBook</b>:</p>
...
<p>Contract of <b>modifyBook</b>:</p>
...
<p>Contract of <b>deleteBook</b>:</p>
...
<p>Contract of <b>createSubject</b>:</p>
...
<p>Contract of <b>querySubject</b>:</p>
...
<p>Contract of <b>modifySubject</b>:</p>
...
<p>Contract of <b>deleteSubject</b>:</p>
...
<p>Contract of <b>addBookCopy</b>:</p>
...
<p>Contract of <b>queryBookCopy</b>:</p>
...
<p>Contract of <b>modifyBookCopy</b>:</p>
...
<p>Contract of <b>deleteBookCopy</b>:</p>
...
<p>Contract of <b>createLibrarian</b>:</p>
...
<p>Contract of <b>queryLibrarian</b>:</p>
...
<p>Contract of <b>modifyLibrarian</b>:</p>
...
<p>Contract of <b>deleteLibrarian</b>:</p>
...
![libmsConceptualClassDiagram](../../imgs/RM2Doc/libmsConceptualClassDiagram.jpg)
...
<table>
	...
	<tr>
	    ...
	    <td colspan="2">The user account</td>
	</tr>
	<tr>
	...
	<tr>
	    <td>Faculty</td>
	<td>String</td>
	<td>The Faculty of User</td>
					</tr>
	<tr>
	    <td>LoanedNumber</td>
	<td>Integer</td>
	<td>The LoanedNumber of User</td>
					</tr>
	<tr>
	    <td>BorrowStatus</td>
	<td>[NORMAL|SUSPEND]</td>
	<td>The BorrowStatus of User</td>
					</tr>
	<tr>
	    <td>SuspensionDays</td>
	<td>Integer</td>
	<td>The SuspensionDays of User</td>
					</tr>
	<tr>
	    <td>OverDueFee</td>
	<td>Real</td>
	<td>The OverDueFee of User</td>
					</tr>
	<tr>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSStudent">Student</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E2</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The student account</td>
	</tr>
	<tr>
		<td><b>Super Entity:</b></td>
		<td colspan="2"><a href="#CLASSUser">User</a></td>
					</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>Major</td>
	<td>String</td>
	<td>The Major of Student</td>
					</tr>
	<tr>
	    <td>Programme</td>
	<td>[BACHELOR|MASTER|PHD]</td>
	<td>The Programme of Student</td>
					</tr>
	<tr>
	    <td>RegistrationStatus</td>
	<td>[GRADUATED|PROGRAMMING]</td>
	<td>The RegistrationStatus of Student</td>
					</tr>
	</table>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSFaculty">Faculty</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E3</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The facuity account</td>
	</tr>
	<tr>
		<td><b>Super Entity:</b></td>
		<td colspan="2"><a href="#CLASSUser">User</a></td>
	...
	<td>The Position of Faculty</td>
					</tr>
	<tr>
	    <td>Status</td>
	<td>[HASRETIRED|INPOSITION]</td>
	<td>The Status of Faculty</td>
					</tr>
	</table>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSBook">Book</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E4</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">Books owned by the library</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>CallNo</td>
	<td>String</td>
	<td>The CallNo of Book</td>
					</tr>
	<tr>
	    <td>Title</td>
	<td>String</td>
	<td>The Title of Book</td>
					</tr>
	<tr>
	    <td>Edition</td>
	<td>String</td>
	<td>The Edition of Book</td>
					</tr>
	<tr>
	    <td>Author</td>
	<td>String</td>
	<td>The Author of Book</td>
					</tr>
	<tr>
	    <td>Publisher</td>
	<td>String</td>
	<td>The Publisher of Book</td>
					</tr>
	<tr>
	    <td>Description</td>
	<td>String</td>
	<td>The Description of Book</td>
					</tr>
	<tr>
	    <td>ISBn</td>
	<td>String</td>
	<td>The ISBn of Book</td>
					</tr>
	<tr>
	    <td>CopyNum</td>
	<td>Integer</td>
	<td>The CopyNum of Book</td>
					</tr>
	<tr>
	    <td><b>Relationship Name</b></td>
	<td><b>Related Entity</b></td>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSSubject">Subject</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E5</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The subject of books</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSBookCopy">BookCopy</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E6</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The copy of a book for borrowing</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>Barcode</td>
	<td>String</td>
	<td>The Barcode of BookCopy</td>
					</tr>
	<tr>
	    <td>Status</td>
	<td>[AVAILABLE|INPROCESSING|LIBUSEONLY|ONHOLDSHELF|LOANED]</td>
	<td>The Status of BookCopy</td>
					</tr>
	<tr>
	    <td>Location</td>
	<td>String</td>
	<td>The Location of BookCopy</td>
					</tr>
	<tr>
	    <td>IsReserved</td>
	<td>Boolean</td>
	<td>The IsReserved of BookCopy</td>
					</tr>
	<tr>
	    <td><b>Relationship Name</b></td>
	<td><b>Related Entity</b></td>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSLoan">Loan</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E7</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The record of borrowing books</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>LoanDate</td>
	<td>LocalDate</td>
	<td>The LoanDate of Loan</td>
					</tr>
	<tr>
	    <td>RenewDate</td>
	<td>LocalDate</td>
	<td>The RenewDate of Loan</td>
					</tr>
	<tr>
	    <td>DueDate</td>
	<td>LocalDate</td>
	<td>The DueDate of Loan</td>
					</tr>
	<tr>
	    <td>ReturnDate</td>
	<td>LocalDate</td>
	<td>The ReturnDate of Loan</td>
					</tr>
	<tr>
	    <td>RenewedTimes</td>
	<td>Integer</td>
	<td>The RenewedTimes of Loan</td>
					</tr>
	<tr>
	    <td>IsReturned</td>
	<td>Boolean</td>
	<td>The IsReturned of Loan</td>
					</tr>
	<tr>
	    <td>OverDueFee</td>
	<td>Real</td>
	<td>The OverDueFee of Loan</td>
					</tr>
	<tr>
	    <td>OverDue3Days</td>
	<td>Boolean</td>
	<td>The OverDue3Days of Loan</td>
					</tr>
	<tr>
	    <td>OverDue10Days</td>
	<td>Boolean</td>
	<td>The OverDue10Days of Loan</td>
					</tr>
	<tr>
	    <td>OverDue17Days</td>
	<td>Boolean</td>
	<td>The OverDue17Days of Loan</td>
					</tr>
	<tr>
	    <td>OverDue31Days</td>
	<td>Boolean</td>
	<td>The OverDue31Days of Loan</td>
					</tr>
	<tr>
	    <td><b>Relationship Name</b></td>
	<td><b>Related Entity</b></td>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSReserve">Reserve</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E8</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The record of book reservation</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>ReserveDate</td>
	<td>LocalDate</td>
	<td>The ReserveDate of Reserve</td>
					</tr>
	<tr>
	    <td>IsReserveClosed</td>
	<td>Boolean</td>
	<td>The IsReserveClosed of Reserve</td>
					</tr>
	<tr>
	    <td><b>Relationship Name</b></td>
	<td><b>Related Entity</b></td>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSRecommendBook">RecommendBook</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E9</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The book recommended by users to the library</td>
	</tr>
	<tr>
		<td><b>Super Entity:</b></td>
		<td colspan="2"><a href="#CLASSBook">Book</a></td>
					</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>RecommendDate</td>
	<td>LocalDate</td>
	<td>The RecommendDate of RecommendBook</td>
					</tr>
	<tr>
	    <td><b>Relationship Name</b></td>
	<td><b>Related Entity</b></td>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSAdministrator">Administrator</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E10</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The administrator account</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>AdminID</td>
	<td>String</td>
	<td>The AdminID of Administrator</td>
					</tr>
	<tr>
	    <td>UserName</td>
	<td>String</td>
	<td>The UserName of Administrator</td>
					</tr>
	<tr>
	    <td>Password</td>
	<td>String</td>
	<td>The Password of Administrator</td>
					</tr>
	</table>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSLibrarian">Librarian</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E11</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The librarian account</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>LibrarianID</td>
	<td>String</td>
	<td>The LibrarianID of Librarian</td>
					</tr>
	<tr>
	    <td>Name</td>
	<td>String</td>
	<td>The Name of Librarian</td>
					</tr>
	<tr>
	    <td>Password</td>
	<td>String</td>
	<td>The Password of Librarian</td>
					</tr>
	</table>
​	 
