...
### CoCoME Requirements Model - Fully Download
...
![CoCoMEUseCaseDiagram](../../imgs/RM2Doc/CoCoMEUseCaseDiagram.jpg)
...
<table>
	...
	<tr>
		...
		<td>
		<p><a href="#OPmakeNewSale">makeNewSale</a></p><p><a href="#OPenterItem">enterItem</a></p><p><a href="#OPendSale">endSale</a></p><p><a href="#OPmakeCashPayment">makeCashPayment</a></p><p><a href="#OPmakeCardPayment">makeCardPayment</a></p>
		</td>
	</tr>
	<tr>
		<td>UC2</td>
	...
	<tr>
		...
		<td>
		<p><a href="#OPcreateProductCatalog">createProductCatalog</a></p><p><a href="#OPqueryProductCatalog">queryProductCatalog</a></p><p><a href="#OPmodifyProductCatalog">modifyProductCatalog</a></p><p><a href="#OPdeleteProductCatalog">deleteProductCatalog</a></p>
		</td>
	</tr>
	<tr>
		<td>UC13</td>
		...
		<td>
		<p><a href="#OPcreateCashDesk">createCashDesk</a></p><p><a href="#OPqueryCashDesk">queryCashDesk</a></p><p><a href="#OPmodifyCashDesk">modifyCashDesk</a></p><p><a href="#OPdeleteCashDesk">deleteCashDesk</a></p>
		</td>
	</tr>
	<tr>
		<td>UC14</td>
		...
		<td>
		<p><a href="#OPcreateCashier">createCashier</a></p><p><a href="#OPqueryCashier">queryCashier</a></p><p><a href="#OPmodifyCashier">modifyCashier</a></p><p><a href="#OPdeleteCashier">deleteCashier</a></p>
		</td>
	</tr>
	<tr>
		<td>UC15</td>
	...
	<tr>
		...
		<td>
		<p><a href="#OPcreateSupplier">createSupplier</a></p><p><a href="#OPquerySupplier">querySupplier</a></p><p><a href="#OPmodifySupplier">modifySupplier</a></p><p><a href="#OPdeleteSupplier">deleteSupplier</a></p>
		</td>
	</tr>
</table>
...
<table>
	...
	<tr>
		<td>A1</td>
		<td><span name ="ACTORCashier">Cashier</span></td>
		<td>The cashier is responsible for opening or closing the cash desk and the checkout of items</td>
		<td></td>
	</tr><tr>
		<td>A2</td>
		<td><span name ="ACTORStoreManager">StoreManager</span></td>
		<td>The store manager is responsible for procurement and price setting of items,and opening or closing the store</td>
		<td></td>
	</tr><tr>
		<td>A3</td>
		<td><span name ="ACTORAdministrator">Administrator</span></td>
		<td>The system administrator is responsible for managing information, including store information, cash desk information, cashier information, item information, item catalogue information and supplier information</td>
		<td></td>
	</tr>
</table>
...
![CoCoMEProcessSaleSSD](../../imgs/RM2Doc/CoCoMEProcessSaleSSD.jpg)
...
<td><p><i>sto</i> is the object <i>s</i> in the instance set of class <a href="#CLASSStore">Store</a>. <i>s</i> represents an object of class <a href="#CLASSStore">Store</a>, and <i>s</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>s</i> is equal to <i>storeID</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>1. The object <i>sto</i> exists</p><p>2. The attribute <i>IsOpened</i> of the object <i>sto</i> is equal to <b>false</b></p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<td><p><i>sto</i> is the object <i>s</i> in the instance set of class <a href="#CLASSStore">Store</a>. <i>s</i> represents an object of class <a href="#CLASSStore">Store</a>, and <i>s</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>s</i> is equal to <i>storeID</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>1. The object <i>sto</i> exists</p><p>2. The attribute <i>IsOpened</i> of the object <i>sto</i> is equal to <b>true</b></p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>closeStore</b>:</p>
...
<td><p><i>cd</i> is the object <i>s</i> in the instance set of class <a href="#CLASSCashDesk">CashDesk</a>. <i>s</i> represents an object of class <a href="#CLASSCashDesk">CashDesk</a>, and <i>s</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>s</i> is equal to <i>cashDeskID</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>1. The object <i>cd</i> exists</p><p>2. The attribute <i>IsOpened</i> of the object <i>cd</i> is equal to <b>false</b></p><p>3. The object <i>CurrentStore</i> exists</p><p>4. The attribute <i>IsOpened</i> of the object <i>CurrentStore</i> is equal to <b>true</b></p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>openCashDesk</b>:</p>
...
<td><p><i>cd</i> is the object <i>s</i> in the instance set of class <a href="#CLASSCashDesk">CashDesk</a>. <i>s</i> represents an object of class <a href="#CLASSCashDesk">CashDesk</a>, and <i>s</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>s</i> is equal to <i>cashDeskID</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>1. The object <i>cd</i> exists</p><p>2. The attribute <i>IsOpened</i> of the object <i>cd</i> is equal to <b>true</b></p><p>3. The object <i>CurrentStore</i> exists</p><p>4. The attribute <i>IsOpened</i> of the object <i>CurrentStore</i> is equal to <b>true</b></p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>closeCashDesk</b>:</p>
...
<tr>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>1. The object <i>CurrentCashDesk</i> exists</p><p>2. The attribute <i>IsOpened</i> of the object <i>CurrentCashDesk</i> is equal to <b>true</b></p><p>3. (the object <i>CurrentSale</i> doesn't exist, or (the object <i>CurrentSale</i> exists, and the attribute <i>IsComplete</i> of the object <i>CurrentSale</i> is equal to <b>true</b>))</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>makeNewSale</b>:</p>
...
<p>Contract of <b>makeCardPayment</b>:</p>
...
<p>Contract of <b>thirdPartyCardPaymentService</b>:</p>
...
<p>Contract of <b>listAllOutOfStoreProducts</b>:</p>
...
<td><p><i>sup</i> is the object <i>s</i> in the instance set of class <a href="#CLASSSupplier">Supplier</a>. <i>s</i> represents an object of class <a href="#CLASSSupplier">Supplier</a>, and <i>s</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>s</i> is equal to <i>supplierID</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>1. The object <i>sup</i> exists</p><p>2. The object <i>CurrentOrderProduct</i> exists</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>chooseSupplier</b>:</p>
...
<p>Contract of <b>changePrice</b>:</p>
...
<p>Contract of <b>listSuppliers</b>:</p>
...
<p>Contract of <b>showStockReports</b>:</p>
...
<td><p><i>productcatalog</i> is the object <i>pro</i> in the instance set of class <a href="#CLASSProductCatalog">ProductCatalog</a>. <i>pro</i> represents an object of class <a href="#CLASSProductCatalog">ProductCatalog</a>, and <i>pro</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>pro</i> is equal to <i>id</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>The object <i>productcatalog</i> doesn't exist</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>createProductCatalog</b>:</p>
...
<td><p><i>productcatalog</i> is the object <i>pro</i> in the instance set of class <a href="#CLASSProductCatalog">ProductCatalog</a>. <i>pro</i> represents an object of class <a href="#CLASSProductCatalog">ProductCatalog</a>, and <i>pro</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>pro</i> is equal to <i>id</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>The object <i>productcatalog</i> exists</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>queryProductCatalog</b>:</p>
...
<p>Contract of <b>modifyProductCatalog</b>:</p>
...
<td><p><i>productcatalog</i> is the object <i>pro</i> in the instance set of class <a href="#CLASSProductCatalog">ProductCatalog</a>. <i>pro</i> represents an object of class <a href="#CLASSProductCatalog">ProductCatalog</a>, and <i>pro</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>pro</i> is equal to <i>id</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>1. The object <i>productcatalog</i> exists</p><p>2. The object <i>productcatalog</i> is in the instance set of class <a href="#CLASSProductCatalog">ProductCatalog</a></p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>deleteProductCatalog</b>:</p>
...
<td><p><i>cashdesk</i> is the object <i>cas</i> in the instance set of class <a href="#CLASSCashDesk">CashDesk</a>. <i>cas</i> represents an object of class <a href="#CLASSCashDesk">CashDesk</a>, and <i>cas</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>cas</i> is equal to <i>id</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>The object <i>cashdesk</i> doesn't exist</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>createCashDesk</b>:</p>
...
<td><p><i>cashdesk</i> is the object <i>cas</i> in the instance set of class <a href="#CLASSCashDesk">CashDesk</a>. <i>cas</i> represents an object of class <a href="#CLASSCashDesk">CashDesk</a>, and <i>cas</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>cas</i> is equal to <i>id</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>The object <i>cashdesk</i> exists</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>queryCashDesk</b>:</p>
...
<p>Contract of <b>modifyCashDesk</b>:</p>
...
<td><p><i>cashdesk</i> is the object <i>cas</i> in the instance set of class <a href="#CLASSCashDesk">CashDesk</a>. <i>cas</i> represents an object of class <a href="#CLASSCashDesk">CashDesk</a>, and <i>cas</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>cas</i> is equal to <i>id</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>1. The object <i>cashdesk</i> exists</p><p>2. The object <i>cashdesk</i> is in the instance set of class <a href="#CLASSCashDesk">CashDesk</a></p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>deleteCashDesk</b>:</p>
...
<td><p><i>cashier</i> is the object <i>cas</i> in the instance set of class <a href="#CLASSCashier">Cashier</a>. <i>cas</i> represents an object of class <a href="#CLASSCashier">Cashier</a>, and <i>cas</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>cas</i> is equal to <i>id</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>The object <i>cashier</i> doesn't exist</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>createCashier</b>:</p>
...
<td><p><i>cashier</i> is the object <i>cas</i> in the instance set of class <a href="#CLASSCashier">Cashier</a>. <i>cas</i> represents an object of class <a href="#CLASSCashier">Cashier</a>, and <i>cas</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>cas</i> is equal to <i>id</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>The object <i>cashier</i> exists</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>queryCashier</b>:</p>
...
<p>Contract of <b>modifyCashier</b>:</p>
...
<td><p><i>cashier</i> is the object <i>cas</i> in the instance set of class <a href="#CLASSCashier">Cashier</a>. <i>cas</i> represents an object of class <a href="#CLASSCashier">Cashier</a>, and <i>cas</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>cas</i> is equal to <i>id</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>1. The object <i>cashier</i> exists</p><p>2. The object <i>cashier</i> is in the instance set of class <a href="#CLASSCashier">Cashier</a></p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>deleteCashier</b>:</p>
...
<td><p><i>item</i> is the object <i>ite</i> in the instance set of class <a href="#CLASSItem">Item</a>. <i>ite</i> represents an object of class <a href="#CLASSItem">Item</a>, and <i>ite</i> meets:</p><p>&emsp;&emsp;The attribute <i>Barcode</i> of the object <i>ite</i> is equal to <i>barcode</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>The object <i>item</i> doesn't exist</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<td><p><i>supplier</i> is the object <i>sup</i> in the instance set of class <a href="#CLASSSupplier">Supplier</a>. <i>sup</i> represents an object of class <a href="#CLASSSupplier">Supplier</a>, and <i>sup</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>sup</i> is equal to <i>id</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>The object <i>supplier</i> doesn't exist</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>createSupplier</b>:</p>
...
<td><p><i>supplier</i> is the object <i>sup</i> in the instance set of class <a href="#CLASSSupplier">Supplier</a>. <i>sup</i> represents an object of class <a href="#CLASSSupplier">Supplier</a>, and <i>sup</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>sup</i> is equal to <i>id</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>The object <i>supplier</i> exists</p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>querySupplier</b>:</p>
...
<p>Contract of <b>modifySupplier</b>:</p>
...
<td><p><i>supplier</i> is the object <i>sup</i> in the instance set of class <a href="#CLASSSupplier">Supplier</a>. <i>sup</i> represents an object of class <a href="#CLASSSupplier">Supplier</a>, and <i>sup</i> meets:</p><p>&emsp;&emsp;The attribute <i>Id</i> of the object <i>sup</i> is equal to <i>id</i></p></td>
	...
	<tr>
<td><b>Preconditions:</b></td>
		<td><p>1. The object <i>supplier</i> exists</p><p>2. The object <i>supplier</i> is in the instance set of class <a href="#CLASSSupplier">Supplier</a></p></td>
</tr>
	<tr>
		<td><b>Postconditions:</b></td>
...
<p>Contract of <b>deleteSupplier</b>:</p>
...
![CoCoMEConceptualClassDiagram](../../imgs/RM2Doc/CoCoMEConceptualClassDiagram.jpg)
...
<table>
	...
	<tr>
	    ...
	    <td colspan="2">The place where items are sold</td>
	</tr>
	<tr>
...
<table>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The catalogue of items</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSCashDesk">CashDesk</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E3</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The cash desk in store</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>Id</td>
	<td>Integer</td>
	<td>The Id of CashDesk</td>
					</tr>
	<tr>
	    <td>Name</td>
	<td>String</td>
	<td>The Name of CashDesk</td>
					</tr>
	<tr>
	    <td>IsOpened</td>
	<td>Boolean</td>
	<td>The IsOpened of CashDesk</td>
					</tr>
	<tr>
	    <td><b>Relationship Name</b></td>
	<td><b>Related Entity</b></td>
...
<table>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The sales order for items</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSCashier">Cashier</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E5</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The cashier in store</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSSalesLineItem">SalesLineItem</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E6</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The sales order for a item</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>Quantity</td>
	<td>Integer</td>
	<td>The Quantity of SalesLineItem</td>
					</tr>
	<tr>
	    <td>Subamount</td>
	<td>Real</td>
	<td>The Subamount of SalesLineItem</td>
					</tr>
	<tr>
	    <td><b>Relationship Name</b></td>
	<td><b>Related Entity</b></td>
...
<table>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The item to be sold</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
...
<table>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The bill for the goods sold</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
...
<table>
	...
	<td>String</td>
	<td>The CardAccountNumber of CardPayment</td>
					</tr>
	<tr>
	    <td>ExpiryDate</td>
	<td>LocalDate</td>
	<td>The ExpiryDate of CardPayment</td>
					</tr>
	</table>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSOrderEntry">OrderEntry</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E11</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The purchase order for a item</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>Quantity</td>
	<td>Integer</td>
	<td>The Quantity of OrderEntry</td>
					</tr>
	<tr>
	    <td>SubAmount</td>
	<td>Real</td>
	<td>The SubAmount of OrderEntry</td>
					</tr>
	<tr>
	    <td><b>Relationship Name</b></td>
	<td><b>Related Entity</b></td>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSSupplier">Supplier</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E12</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The supplier of items</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>Id</td>
	<td>Integer</td>
	<td>The Id of Supplier</td>
					</tr>
	<tr>
	    <td>Name</td>
	<td>String</td>
	<td>The Name of Supplier</td>
					</tr>
	</table>
...
<table>
	<tr>
		<td><b>Entity Name:</b></td>
		   <td colspan="2"><span name ="CLASSOrderProduct">OrderProduct</span></td>
	</tr>
	<tr>
		<td><b>Entity ID:</b></td>
		   <td colspan="2">E13</td>
	...
	<tr>
	    <td><b>Entity Description:</b></td>
	    <td colspan="2">The purchase order for items</td>
	</tr>
	<tr>
	    <td><b>Attribute Name</b></td>
		<td><b>Attribute Type</b></td>
	...
	<tr>
	    <td>Id</td>
	<td>Integer</td>
	<td>The Id of OrderProduct</td>
					</tr>
	<tr>
	    <td>Time</td>
	<td>LocalDate</td>
	<td>The Time of OrderProduct</td>
					</tr>
	<tr>
	    <td>OrderStatus</td>
	<td>[NEW|RECEIVED|REQUESTED]</td>
	<td>The OrderStatus of OrderProduct</td>
					</tr>
	<tr>
	    <td>Amount</td>
	<td>Real</td>
	<td>The Amount of OrderProduct</td>
					</tr>
	<tr>
	    <td><b>Relationship Name</b></td>
	<td><b>Related Entity</b></td>
